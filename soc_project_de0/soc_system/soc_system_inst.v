	soc_system u0 (
		...
		.i_vga_ram_clk_clk               (<connected-to-i_vga_ram_clk_clk>),               // i_vga_ram_clk.clk
		.i_vga_ram_rst_reset             (<connected-to-i_vga_ram_rst_reset>),             // i_vga_ram_rst.reset
		.i_vga_ram_rst_reset_req         (<connected-to-i_vga_ram_rst_reset_req>),         //              .reset_req
		...
		.o_clock_100m_clk                (<connected-to-o_clock_100m_clk>),                //  o_clock_100m.clk
		.o_clock_40m_clk                 (<connected-to-o_clock_40m_clk>),                 //   o_clock_40m.clk
		.led_ram_address                 (<connected-to-led_ram_address>),                 //       led_ram.address
		.led_ram_chipselect              (<connected-to-led_ram_chipselect>),              //              .chipselect
		.led_ram_clken                   (<connected-to-led_ram_clken>),                   //              .clken
		.led_ram_write                   (<connected-to-led_ram_write>),                   //              .write
		.led_ram_readdata                (<connected-to-led_ram_readdata>),                //              .readdata
		.led_ram_writedata               (<connected-to-led_ram_writedata>),               //              .writedata
		.led_ram_byteenable              (<connected-to-led_ram_byteenable>),              //              .byteenable
		.vga_ram_address                 (<connected-to-vga_ram_address>),                 //       vga_ram.address
		.vga_ram_chipselect              (<connected-to-vga_ram_chipselect>),              //              .chipselect
		.vga_ram_clken                   (<connected-to-vga_ram_clken>),                   //              .clken
		.vga_ram_write                   (<connected-to-vga_ram_write>),                   //              .write
		.vga_ram_readdata                (<connected-to-vga_ram_readdata>),                //              .readdata
		.vga_ram_writedata               (<connected-to-vga_ram_writedata>),               //              .writedata
		.vga_ram_byteenable              (<connected-to-vga_ram_byteenable>),              //              .byteenable
